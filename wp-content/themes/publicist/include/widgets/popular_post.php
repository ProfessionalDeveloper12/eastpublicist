<?php
/**
 * Popular Post widget class Publicist
 *
 * @since 2.8.0
 */
class Publicist_Widget_Popular extends WP_Widget {

	public function __construct() {

		$widget_ops = array( 'classname' => 'widget_post', 'description' => esc_html__( "", "publicist" ) );

		parent::__construct('widget_popularpost', esc_html__('Publicist :: Popular Posts', "publicist"), $widget_ops);
	...
	public function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Popular Posts', "publicist" );
