...
if( publicist_options('opt_logotype') == "2" && $limg != "" ) { // Logo - Image
	?>
	<a class="navbar-brand image-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e('Logo',"publicist"); ?>">
...
elseif( publicist_options('opt_logotype') == "1" && $lsitetitle != "" ) { // Logo - Site Title
	?>
	<a class="navbar-brand text-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo get_bloginfo($lsitetitle); ?>"><?php echo get_bloginfo( $lsitetitle ); ?></a>
	<?php
}
elseif( publicist_options('opt_logotype') == "3" && $lcustomtxt != "" ) { // Logo - Custom Text
	?>
	<a class="navbar-brand text-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr($lcustomtxt); ?>">
